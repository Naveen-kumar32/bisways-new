...
export default function Layout({ headerStyle, footerStyle, breadcrumbTitle, children, mainCls, breadcrumbAlt,breadcrumbImage, hero }) {
	...
	return (
		<><div id="top" />
			...
			<div id="wrapper">
				...
				{hero == 3 && <Hero3 />}
				{hero == 4 && <Hero4 />}
				<Breadcrumb breadcrumbTitle={breadcrumbTitle} breadcrumbAlt={breadcrumbAlt} imageSrc={breadcrumbImage} />
