...
<motion.p
				...
				<p style={{ justifyContent: "center", alignItems: "center", display: "flex", color: "#0b1972", fontSize: '23px',width:"100vw",padding:"0px 200px",textAlign:"center" }}>
					Our services are tailored for entrepreneurs and organisations ready to
					expand, restructure, or strengthen governance.
				</p>
				<div className="row">
					<div className="col-lg-12">
						...
						<div className="feature-group overflow-hidden">
							{[
								{
									img: "/images/section/business-structure-icon-4.svg",
									title: "Growing Businesses",
									text: "For companies seeking scalability and better control over financial and operational structures.",
								},
								{
									img: "/images/section/business-structure-icon-5.svg",
									title: "Founders with Multiple Ventures",
									text: "For entrepreneurs managing different entities who want clarity and strategic consolidation.",
								},
					...
					<div className="col-lg-12 ">
						...
						<div className="feature-group overflow-hidden">
							{[
								{
									img: "/images/section/business-structure-icon-6.svg",
									title: "Family-Run Enterprises",
									text: "For family businesses transitioning into structured, professional entities.",
								},
								{
									img: "/images/section/business-structure-icon-7.svg",
									title: "Funded Startups & Expanding Trusts",
									text: "For startups or trusts looking to scale compliantly while attracting investors and funding.",
								},
