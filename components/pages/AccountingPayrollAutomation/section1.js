		...
		<section ref={setRefs} className="s-why-choose-4 tf-spacing-3">
			<div className="content-wrap tf-spacing-3">
				<div className="content-left">
					...
					>
						...
						<span style={{ color: '#e6ac41' }}> Financial Efficiency</span>
					</motion.p>
				...
				<div className="image-right">
					<div className="image-wrap image" style={{ borderRadius: '16px' }}>
						<Image
							...
							src="/images/section/account-1.svg"
							alt="cfo"
							className="lazyload"
						/>
					</div>
			...
			<div className="content-wrap wrap-2">
				<div className="image-left relative">
					<div className="image-wrap image" style={{ borderRadius: '16px' }}>
						<Image
							...
							sizes="(max-width: 768px) 100vw, 50vw"
							style={{ width: '100%', height: 'auto', display: 'block' }}
							src="/images/section/account-2.svg"
							alt="cfo-2"
							className="lazyload"
						/>
					</div>
				...
				<div className="content-right">
					...
					>
						Smart Choice for Financial

						<span style={{ color: '#e6ac41' }}> Management Excellence</span>
					</motion.p>
