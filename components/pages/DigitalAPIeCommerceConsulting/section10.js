				...
				<div className="row">
					<div className="col-lg-12">
						...
						<div className="feature-group overflow-hidden">
							{[
								{
									img: "/images/section/digital-icon-4.svg",
									title: "Recharge & API Providers",
									text: "For fintech and utility platforms managing high-volume transactions online.",
								},
								{
									img: "/images/section/digital-icon-5.svg",
									title: "Digital Entrepreneurs & Startups",
									text: "For tech founders launching or scaling API and web-based solutions.",
								},
					...
					<div className="col-lg-12 ">
						...
						<div className="feature-group overflow-hidden">
							{[
								{
									img: "/images/section/digital-icon-6.svg",
									title: "Influencers & Creators",
									text: "For YouTubers, freelancers, and digital professionals earning from online platforms.",
								},
								{
									img: "/images/section/digital-icon-7.svg",
									title: "eCommerce & D2C Sellers",
									text: "For online brands or marketplaces needing registration, IP, and tax compliance.",
								},
